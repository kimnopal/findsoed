                        ...
                        @foreach ($elements as $index => $element)
                            ...
                            @if (is_string($element))
                                <span aria-disabled="true">
                                    <span
                                        class="min-h-[38px] min-w-[38px] flex justify-center items-center text-gray-800 hover:bg-gray-100 py-2 px-3 text-sm rounded-lg focus:outline-none focus:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none dark:text-white dark:hover:bg-white/10 dark:focus:bg-white/10">{{ $element }}</span>
                                </span>
                            @endif
