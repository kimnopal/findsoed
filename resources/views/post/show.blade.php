<x-app-layout>
    ...
    <div class="grid grid-cols-12 mb-3 md:mb-5">
    ...
    <div class="grid grid-cols-12 mb-4">
        <div class="col-span-12 md:col-span-10 md:col-start-2">
            ...
            <x-badge class="mt-3 md:hidden" status="{{ $post['status'] }}">{{ ucfirst($post['status']) }}</x-badge>
        </div>
    </div>
    ...
    <div class="grid grid-cols-12 mb-4">
        <div class="col-span-12 md:col-span-10 md:col-start-2">
            <img src="{{ asset('images/posts/' . $post['photo']) }}" alt="Foto Barang Hilang"
                class="w-full min-h-72 h-72 md:min-h-96 md:h-96 object-cover rounded-lg">
        </div>
    </div>

    <div class="grid grid-cols-12 mb-4">
        <div class="col-span-12 md:col-span-10 md:col-start-2">
            <div class="flex justify-between md:justify-start gap-3 items-center flex-wrap">
                ...
                <span class="size-1 bg-gray-300 rounded-full hidden md:inline dark:bg-neutral-600"></span>
                <x-badge class="hidden md:inline"
                    status="{{ $post['status'] }}">{{ ucfirst($post['status']) }}</x-badge>
                <span class="size-1 bg-gray-300 rounded-full hidden md:inline dark:bg-neutral-600"></span>
